...
function Chat() {
  ...
  useEffect(() => {
    // if the new message is not null, the current chat is not null, 
    // and the current chat contains the sender of the new message, 
    ...
    <>
      ...
      <div className="chat">
        <div className="chatMenu">
          {/* an input field to search for a user */}
          ...
          <div className='followedUsersContainer'>
            {
              ...
              onlineUsers.length !== 0 && <h3 className='columnTitle'>Online Users</h3>
            }
            <ul className='followedUsersList'>
              <ChatUserSearch onlineUsers={onlineUsers} currUser={user} setCurrChat={setCurrChat}/>
            </ul>
          </div>
        </div>
      </div>
